...
contract VerifyYnBfBTCkStrategy is KernelVerifyScript {
    ...
    function verify() internal view {
        ...
        assertEq(vault_.getAssetWithdrawable(contracts.BTCB()), false, "asset[0].withdrawable is invalid");

        assertEq(assets[1], contracts.BFBTC(), "assets[1] is invalid");
        asset = vault_.getAsset(contracts.BFBTC());
        ...
        assertEq(vault_.getAssetWithdrawable(contracts.BFBTC()), true, "asset[1].withdrawable is invalid");
